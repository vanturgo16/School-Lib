...
<body class="signup-body">
		<div class="agile-signup">	
			...
			<div class="content2">
                ...
                @elseif(session('statusNotMatch'))
					<div class="alert alert-danger" role="alert">
						<strong>{{ session('statusNotMatch') }}</strong>
					</div> 
                @endif
				<form action="{{ url('/resetpass/submit') }}" method="post" enctype="multipart/form-data">
                    @csrf
				...
				<br>
				<div>
					<a href="{{ url('/') }}" class="btn btn-info btn-sm">Login</a>
				</div>
				<div class="copyright">
